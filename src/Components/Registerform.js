            ...
            <div className="register-form-container">
              ...
              >
                <div
                  ...
                  style={{width:'100%',display:'flex',marginRight:'105px'}}
                >
                  <div>
                    <p>
                      <label>
              ...
              <div className="submitbtn" style={{marginLeft:'20px',marginRight:'150px'}}>
                <button className="submit btn blue darken-2">
                  <span>Submit</span>
                </button>
              </div>
              <div>
